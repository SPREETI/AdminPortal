	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-7">
	                            <input type="text" ng-model="ctrl.user.name" id="uname" class="username form-control input-sm" placeholder="Enter your user name" required ng-minlength="3"/>
	                        </div>
	                    </div>
	                </div>
	             ...
	             <!--   <div class="row">
	                  ...
	                  <div class="row">
	                    <div class="form-group col-md-12">
	                        <label class="col-md-2 control-lable" for="gpn">GPN</label>
	                        <div class="col-md-7">
	                            <input type="text" ng-model="ctrl.user.gpn" id="gpn" class="form-control input-sm" placeholder="Enter your GPN." required"/>
	                        </div>
	                    </div>
	                </div>
